...
function Home() {
  ...
  return (
    ...
    ">
      ...
      <div className="w-full max-w-md h-auto lg:h-96 flex items-center justify-center">
        <div className="
          text-center
          bg-white
          rounded-xl
        ...
        ">
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-blue-900 mb-4">
